...
def cell(cps, name, done):
    if cps in done:
        return f'<img src="{quote(done[cps].as_posix())}" width="28" height="28" align="middle" title="{name}">'
    return f'<img src="assets/placeholder.svg" width="28" height="28" align="middle" title="{name}">'
